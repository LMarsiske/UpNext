const PrivacyPolicyPage = () => {
  <div>
    ...
    <p>
      Lucas Marsiske built the UpNext app as a Free app. This SERVICE is
      provided by Lucas Marsiske at no cost and is intended for use as is.
    </p>{" "}
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which are accessible at UpNext unless otherwise
    ...
    <p>
      ...
      not limited to name, email. The information that I request will be
    ...
    <p>This policy is effective as of 2023-07-16</p>{" "}
    <p>
      <strong>Contact Us</strong>
    </p>{" "}
    <p>
      If you have any questions or suggestions about my Privacy Policy, do not
      hesitate to contact me at lmarsiske@gmail.com.
    </p>{" "}
    <p>
