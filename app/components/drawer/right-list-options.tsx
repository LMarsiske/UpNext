...
const RightDrawerListOptions = () => {
  ...
  return (
    <div className="h-full mt-6 flex flex-col justify-between">
      <div className="flex flex-col">
        <div className="form-control w-full ">
          <label className="label text-lg">List Name</label>
          <input
            type="text"
        ...
        {list && user && list.shareable && list.ownerId === user.id && (
          <div className="flex flex-col mt-6">
            <label className="label text-lg">List Sharing</label>
            <div className="form-control w-full">
              <div className="w-full flex items-stretch mb-4">
                ...
                />
                <button
                  className="w-fit text-lg px-1 py-1 bg-electric-indigo rounded-r-xl text-snow flex items-center shrink-0"
                  onClick={search}
                >
                  <AddIcon />
                  Share
      ...
      <div className="flex flex-col my-6">
        <button
          className="bg-electric-violet  text-snow rounded-xl py-3 w-full text-2xl disabled:bg-fog disabled:text-davy disabled:bg-opacity-50 disabled:cursor-not-allowed transition-colors duration-350 ease-in-out"
        ...
        {user && list?.ownerId === user.id && list?.deleteable && (
          <button
            className="w-full text-2xl rounded-xl bg-fog bg-opacity-70 border-red-700 text-red-700 border-2 mt-6 flex items-center justify-center px-4 py-3"
        ...
        {user && list?.ownerId !== user.id && (
          <button
            ...
            className="w-full text-2xl rounded-xl bg-fog border-red-700 text-red-700 border-2 mt-6 flex items-center justify-center px-4 py-3"
          >
...
export default RightDrawerListOptions;
