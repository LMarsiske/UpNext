    ...
    <AnimatePresence>
      {isDrawerOpen && (
        <motion.div
          ...
          className={`fixed flex flex-col align-bottom rounded-l-xl bg-snow dark:bg-davy text-gunmetal dark:text-snow  top-0 right-0 w-3/4 md:w-[45%] max-w-[450px] h-[100dvh] px-4 py-2 z-[51] shadow-neon`}
        >
